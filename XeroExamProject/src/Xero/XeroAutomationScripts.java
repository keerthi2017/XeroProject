...
public class XeroAutomationScripts extends XeroReUsMethods
{
	...
	public static void Login_To_Xero() throws IOException
	{
		...
		try {
           ...
           //enterText(userName,"keerthig.shet@gmail.com","UserName");
       		//enterText(password,"password123","Password");
       		clickObj(cobj,"Login");
       		//driver.close();
            fStream.close();
	...
	public static void Incorrect_Email() throws IOException
	{
		...
		try {
            ...
            WebElement password = driver.findElement(By.id("password"));
            WebElement cobj=driver.findElement(By.xpath("//*[@id='submitButton']"));
            enterText(userName,"keerthi.shet@gmail.com","UserName");
            enterText(password,"password456","Password");
            clickObj(cobj,"Login");
            fStream.close();
            driver.close();
	...
	clickObj(Freetrail,"Free Trail");
	driver.get("https://www.xero.com/us/signup/");
	//WebElement elem = driver.findElement(By.xpath("html/body/div[6]/main/div[1]/div/div/form/div[9]/span/button"));
	...
	//WebElement recapthca = driver.findElement(By.id("//*[@id='recaptcha-anchor']/div[5]")); 
	//clickObj(recapthca,"recapthca");
	/*enterText(LastName,"sss","UserName");
	enterText(EmailName,"keerthig.shet@gmail.com","UserName");
	enterText(Phone,"1234567890","UserName");
	...
	public static void Login_To_Buynow_Starter() throws IOException, InterruptedException
	{
		...
		try {
        	...
        	enterText(Addr,"3450 granada ave","Addr");
