...
public class XeroReUsMethods extends XeroDriver{
	...
	public static void clickObj(WebElement obj, String objName) throws IOException{
		if(obj.isDisplayed()){
			obj.click();
			Update_Report("Pass", "object ", obj+ " is clicked " + objName + " field");
			System.out.println("Pass: " + objName + " is clicked");
		}else{
			System.out.println("Fail: " + objName + " field is not displayed, please check your application.");
			Update_Report("Fail", "object ", obj+ " is clicked " + objName + " field");
		}
	}
	
	public static void sendkeys(WebElement obj, String objName)
	{
		if(obj.isDisplayed())
		{
			obj.sendKeys(objName);
	...
	public static String[][] readExcel(String dtTablePath,String sheetName ) throws IOException
	 {
		...
		File xlFile = new File("/Users/Keerthi/Desktop/TestSuit.xls"); 
